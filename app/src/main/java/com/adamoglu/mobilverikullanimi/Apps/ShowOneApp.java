...
import com.adamoglu.mobilverikullanimi.Adapters.Adapter_OneApp;
...
public class ShowOneApp extends AppCompatActivity {
    ...
    private Adapter_OneApp listadapter = null;
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                try {
                    if(search.getText().toString().trim().equals("")){
                        ...
                        listadapter = new Adapter_OneApp(getApplication(), dizi_name,dizi_uid,dizi_icon,dizi_color);
                        ...
                        listadapter = new Adapter_OneApp(getApplicationContext(), dizi_name_search,dizi_uid_search,dizi_icon_search,dizi_color_search);
                        listView.setAdapter(listadapter);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_baslik.setText("Bildirim Panelinde Görmek İstediğiniz Uygulamayı Seçiniz");

        packageManager = getPackageManager();


        listadapter = new Adapter_OneApp(getApplicationContext(), dizi_name,dizi_uid,dizi_icon,dizi_color);
        listView.setAdapter(listadapter);
